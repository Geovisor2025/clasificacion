...
var map = new ol.Map({
    ...
    layers: layersList,
    view: new ol.View({
        center: ol.extent.getCenter([-8420093.205108, -2659706.671859, -5728543.375412, -1044238.177555]),
...
map.getView().fit([-9079088.435177, -3249342.843677, -5069548.145343, -508684.519199], map.getSize());
 ...
 * @type {string}
 */
var continuePolygonMsg = "1click para continuar, 2click para parar";
